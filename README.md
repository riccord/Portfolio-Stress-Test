...
Il simulatore segue un processo quantitativo diviso in tre fasi: 
- Stima della Sensibilità (Beta): Utilizza una regressione lineare (OLS) per calcolare il coefficiente $\beta$ di ogni asset rispetto ai tassi storici (periodo 2021-2023). Questo indica quanto      l'asset è storicamente sensibile ai movimenti del costo del denaro.
